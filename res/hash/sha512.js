...
goog.provide('cyphrd.crypto.sha512');
...
cyphrd.crypto.sha512.raw = function(s) {
	s = cyphrd.crypto.utf8.encode(s);
	return cyphrd.crypto.endian.decode(binb_sha512(cyphrd.crypto.endian.encode(s), s.length * 8));
};

// Calculate the HMAC-SHA-512 of a key and some data (raw strings)
// cyphrd.crypto.sha512.raw_hmac = function(key, data){
...
// 	var hash = binb_sha512(ipad.concat(Crypto.encode('Endian', data)), 1024 + data.length * 8);
// 	return Crypto.decode('Endian', binb_sha512(opad.concat(hash), 1024 + 512));
// };

cyphrd.crypto.sha512.hex = function(d) {
	return cyphrd.crypto.hex.encode(cyphrd.crypto.sha512.raw(d));
};
...
// Tests: {
// 	hex: function(){
// 		return Crypto.SHA512.hex("abc").toLowerCase() ==
// 	    "ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a" +
// 	    "2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f";
// 	},

// 	b64: function(){
// 		return Crypto.SHA512.b64("abc") ==
